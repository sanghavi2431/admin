...
import SupervisorInformationFields from "./components/facilityManagerInformationFields";
import { injectReducer } from "@/store";
import reducer from "./store"
import { setButtonType } from "../facility_managerAdd/store/dataSlice";
          ...
          <Form className="flex flex-col justify-between ">
            <FormContainer className="h-screen overflow-auto">
              ...
              {/* <Button
                    ...
                    variant="solid"
                    loading={isSubmitting}
                    className="w-28 text-black bg-[#FFE22D]"
                    color="black"
                    type="submit" 
                    shape="circle"
                    onClick={()=>{
