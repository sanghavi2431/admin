...
const IotFilterTools = (props) => {
  ...
  const IOTdevicesIDs = useSelector((state) => state.iotData.data.IOTdevicesIDs);
  const payload = useSelector((state) => state.iotData.data.payload);
  const selectedFiltersData = useSelector((state) => state.iotData.data.selectedFiltersData);
