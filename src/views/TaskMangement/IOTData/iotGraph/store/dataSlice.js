...
import {
  getDevicePayload,
  getIotDashboardData,
} from "services/taskManagement/iot.service";
...
export const getIOTDashboardData = createAsyncThunk(
  "getIotDashboardData/GetAll",
  async (data) => {
    const response = await getIotDashboardData(data);
    return response.data.results;
  }
);
...
export const getReviewData = createAsyncThunk("review/getIOTData/List", async (data) => {
...
const dataSlice = createSlice({
  ...
  extraReducers: {
    ...
    [getIOTDashboardData.fulfilled]: (state, action) => {
      state.IOTDashboardData = action.payload;
      state.loading = false;
    },
    [getIOTDashboardData.pending]: (state) => {
      state.loading = true;
    },
    [getIOTDashboardData.rejected]: (state) => {
      state.loading = false;
      state.IOTDashboardData = [];
    },
