...
const CleaningEfficiencyChart = ({ data }) => {
  ...
  return (
    <div className="h-full w-full p-6 mx-auto flex items-center">
      <div className="relative w-2/3">
        <h2 className="text-xl font-bold text-center mb-4">Cleaning Efficiency</h2>
        <HighchartsReact highcharts={Highcharts} options={options} />
        <span className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/3 text-2xl font-bold text-black">
