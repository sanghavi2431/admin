              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 ">
                ...
                <div className="lg:col-span-1">
                  <LocationImages
                    ...
                    type={type}
                  />
      <MapConfirmation setFieldValue={setFieldValue} type={type} values={values}  />
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  onClick={() => {
                    let data=location?.state?{...location?.state,"location":{ "id":id,"page":type}}:{"location":{ "id":id,"page":type}}
                    navigate(`/client-Edit/${initialData?.client_name?.value}`,{ state:data });
                  }}
                >
