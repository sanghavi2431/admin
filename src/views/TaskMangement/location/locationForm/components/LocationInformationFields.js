    ...
    <AdaptableCard className="mb-4">
      ...
      <div className="col-span-1">
        ...
        <div className="col-span-2">
          ...
          <FormItem
            label={<Tooltip title="Tap here to open map"><span className="flex cursor-pointer" onClick={()=>dispatch(setMapConfirmation(true))}><FaMapMarkerAlt size="20"/> Address*</span></Tooltip>}
        ...
        <div className="col-span-1 " >
          <FormItem
            label={<Tooltip title="Tap here to open map"><span className="flex cursor-pointer" onClick={()=>dispatch(setMapConfirmation(true))}><FaMapMarkerAlt size="20"/> Latitude*</span></Tooltip>}
        ...
        <div className="col-span-1">
          <FormItem
            label={<Tooltip title="Tap here to open map"><span className="flex cursor-pointer" onClick={()=>dispatch(setMapConfirmation(true))}><FaMapMarkerAlt size="20"/> Longitude*</span></Tooltip>}
