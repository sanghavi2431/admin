...
const MapConfirmation = (props) => {
  ...
  const dialogOpen = useSelector(
    (state) => state.blockAdd?.data?.mapConfirmation
  );
  const latitude = useSelector((state) => state.blockAdd?.data?.latitude);
  const longitude = useSelector((state) => state.blockAdd?.data?.longitude);
  const address = useSelector((state) => state.blockAdd?.data?.address);
  const latlng = useSelector((state) => state.blockAdd?.data?.latlng);
  ...
  const onDialogClose = (e) => {
    ...
    dispatch(
      setCurrentPosition({
        lat: originalValues.latitude,
        lng: originalValues.longitude,
      })
    );
  };
