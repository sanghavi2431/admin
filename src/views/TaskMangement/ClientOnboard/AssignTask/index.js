          ...
          {({ touched, errors, isSubmitting, values, setFieldValue }) => (
            <Form>
              <FormContainer className="flex flex-col gap-6">
                <FormItem label="No. of Toilets*" invalid={errors.numToilets && touched.numToilets} errorMessage={errors.numToilets}>
                  <Field type="number" name="numToilets" component={Input} placeholder="No. of Toilets *" />
                </FormItem>

                <FormItem label="Toilet Cleaning*" invalid={errors.toiletCleaning && touched.toiletCleaning} errorMessage={errors.toiletCleaning}>
                ...
                <FormItem label="General Cleaning*" invalid={errors.generalCleaning && touched.generalCleaning} errorMessage={errors.generalCleaning}>
                ...
                <FormItem label="Frequency of Cleaning*" invalid={errors.cleaningFrequency && touched.cleaningFrequency} errorMessage={errors.cleaningFrequency}>
