...
import AmPmInput from "@/components/ui/TimeInput/AmPmInput";
import TimeInputRange from "@/components/ui/TimeInput/TimeInputRange";
import OpeningHourForm from "@/views/woloos/woloosAddNewForm/components/openingHours";
        ...
        <div className="col-span-1">
          ...
          >
            <Field
              ...
              component={Input}
              placeholder="Recommended By User ID"
              onKeyPress={(e) => {
                if (new RegExp(/[0-9]/).test(e.key)) {
                } else e.preventDefault();
              }}
        ...
        <div className="col-span-1">
          ...
          >
            <Field
              ...
              component={Input}
              placeholder="Recommended Mobile"
              onKeyPress={(e) => {
                if (new RegExp(/[0-9]/).test(e.key)) {
                } else e.preventDefault();
              }}
