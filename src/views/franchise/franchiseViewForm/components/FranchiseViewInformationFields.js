...
const FranchiseViewInformationFields = (props) => {
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 gap-4 ">
            ...
            <Field name="address">
              {({ field, form }) => (
                <Field
                  ...
                  placeholder="Write Woloos address here....."
                  component={Input}
                  disabled
                />
              )}
        ...
        <div className="col-span-1">
          <FormItem
            ...
            invalid={errors.is_clean_and_hygiene && touched.is_clean_and_hygiene}
        ...
        <div className="col-span-1">
          <FormItem
            ...
            invalid={
              errors.is_sanitary_pads_available && touched.is_sanitary_pads_available
            }
        ...
        <div className="col-span-1">
          <FormItem
            ...
            invalid={
              errors.is_makeup_room_available && touched.is_makeup_room_available
            }
        ...
        <div className="col-span-1">
          <FormItem
            ...
            invalid={errors.is_sanitizer_available && touched.is_sanitizer_available}
        ...
        <div className="col-span-1">
          <FormItem
            ...
            invalid={
              errors.is_wheelchair_accessible && touched.is_wheelchair_accessible
            }
...
export default FranchiseViewInformationFields;
