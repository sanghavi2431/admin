...
export const getSettings = createAsyncThunk("getSettingsReview/review", async (data) => {
...
const dataSlice = createSlice({
    ...
    extraReducers: {
        [getSettings.fulfilled]: (state, action) => {
            ...
            let newData = [];
            let obj = {};
            if (action.payload.results.hasOwnProperty("Review")) {
                data = cloneDeep(action.payload.results.Review);
