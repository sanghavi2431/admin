...
export const getSettings = createAsyncThunk("getSettingsAdmin/admin", async (data) => {
...
const dataSlice = createSlice({
    ...
    extraReducers: {
        [getSettings.fulfilled]: (state, action) => {
            ...
            let newData = [];
            let obj = {};
            if (action.payload.results.hasOwnProperty("Admin")) {
                data = cloneDeep(action.payload.results.Admin);
