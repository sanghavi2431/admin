...
import SiteDeleteConfirmation from "../siteForm/components/siteDeleteConfirmation";

injectReducer('siteList', reducer)

const Form = () => {
	const dispatch = useDispatch()
	const data = useSelector((state) => state.siteList.data.settingData)
	const initialFormData = useSelector((state) => state.siteList.data.initialFormData)
	const loading = useSelector((state) => state.siteList.data.loading)
	const fetchData = () => {
		if (loading) return;
