...
export const getSettings = createAsyncThunk("getSettingsSite/site", async (data) => {
...
const dataSlice = createSlice({
    ...
    extraReducers: {
        [getSettings.fulfilled]: (state, action) => {
            ...
            let newData = [];
            let obj = {};
            if (action.payload.results.hasOwnProperty("Site")) {
                data = cloneDeep(action.payload.results.Site);
