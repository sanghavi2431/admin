...
import SiteInformationFields from './components/SiteInformationFields';
import { useState } from 'react'
import { injectReducer } from '@/store'
import reducer from "./store"

injectReducer("siteForm", reducer)
						...
						<FormContainer>
							<div className="grid grid-cols-1 lg:grid-cols-3 gap-4 rounded-lg shadow p-3">
								<div className="lg:col-span-3 grid-cols-3">
									<SiteInformationFields touched={touched} errors={errors} values={values} data={Data} />
								</div>
							</div>
