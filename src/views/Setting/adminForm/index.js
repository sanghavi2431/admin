...
injectReducer("adminForm", reducer)
		...
		<>
			...
			>
				{({ values, touched, errors, isSubmitting }) => (
					<Form>
						<FormContainer>
							<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 rounded-lg shadow p-3">
								<div className="lg:col-span-2 grid-cols-2">
									<AdminInformationFields touched={touched} errors={errors} values={values} data={Data} />
								</div>
							</div>
