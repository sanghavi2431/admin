...
import GeneralDeleteConfirmation from "../generalForm/components/generalDeleteConfirmation";

injectReducer('generalList', reducer)

const Form = () => {
	const dispatch = useDispatch()
	const data = useSelector((state) => state.generalList.data.settingData)
	const initialFormData = useSelector((state) => state.generalList.data.initialFormData)
	const loading = useSelector((state) => state.generalList.data.loading)
	const fetchData = () => {
		if (loading) return;
