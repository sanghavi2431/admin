...
const HostOfferImages = (props) => {
  ...
  return (
    <AdaptableCard className="mb-4">
      <span className="font-semibold">Woloo Host Offer Image</span>
      {values.image !== null && values.image.length > 2 ? (
      ...
      <p className="mb-6">Add or change image for the Woloo Host Offer</p>
      {/* <FormItem
...
export default HostOfferImages;
