              ...
              <div className="w-[25rem]" key={woloo.id}>
                <div className="relative">
                  ...
                  <QRCode
                    ...
                    size={80}
                    value={`https://woloo.page.link/?link=${process.env.REACT_APP_BASE_URL}/api/wolooGuest/wahcertificate/${woloo.id}&apn=in.woloo.www&isi=1571476207&ibi=in.woloo.app`}
                    // value={`https://woloo.page.link?link=${process.env.REACT_APP_BASE_URL}/api/wolooGuest/wahcertificate/${woloo.id}`}
                  />
        ...
        <div className="w-[25rem]" key={wolooById.id}>
          <div className="relative">
            ...
            <QRCode
              className="absolute right-1 bottom-[85px]"
              size={80}
              value={`https://woloo.page.link/?link=${process.env.REACT_APP_BASE_URL}/api/wolooGuest/wahcertificate/${wolooById.id}&apn=in.woloo.www&isi=1571476207&ibi=in.woloo.app`}
              // value={`https://woloo.page.link/?link=${process.env.REACT_APP_BASE_URL}/api/wolooGuest/wahcertificate/${wolooById.id}`}
            />
