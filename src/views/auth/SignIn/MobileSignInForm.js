...
import { apiMobileSignIn } from "services/AuthService";
import { setResultmessage } from "views/voucher/voucherAddNew/store/dataSlice";
...
const SignInUsingMobileForm = (props) => {
  ...
  const onSignIn = async (values, setSubmitting) => {
    ...
    try {
      setSubmitting(true);
      const result = await apiMobileSignIn({ mobileNumber:mobile });
