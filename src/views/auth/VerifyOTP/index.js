...
import { apiMobileSignIn, apiMobileVerifyOTP } from 'services/AuthService'
...
const VerifyOtp = (props) => {
    ...
    const onResendOtp = async (e) => {
        try {
            ...
            const result = await apiMobileSignIn({ mobileNumber:mobileNumber });
            // let resp=1
            ...
            <Formik
                ...
                onSubmit={async (values, { setSubmitting, resetForm }) => {
                    ...
                    try {
                        ...
                        const resp = await apiMobileVerifyOTP(payload);
