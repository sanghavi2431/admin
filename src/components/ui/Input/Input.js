...
const Input = React.forwardRef((props, ref) => {
	...
	const inputDefaultClass = `input focus:ring-0 focus:outline-none shadow-custom px-6`
	...
	const renderTextArea = (
		<textarea style={{ ...style, borderRadius }} {...inputProps}></textarea>
	)

	const renderInput = (
		<Component style={{...affixGutterStyle(), ...style, borderRadius}} {...inputProps} />
	)
