...
const Dialog = props => {
	...
	const { elementRef, borderRadius, updateBorderRadius } = useDynamicBorderRadius(isOpen);
	...
	const renderCloseButton = (
		<CloseButton onClick={onCloseClick} className="ltr:right-10 rtl:left-6" absolute />
	)
